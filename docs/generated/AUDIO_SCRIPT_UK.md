...
| Нуль. | завжди | `audio/uk/common/countdown_0.m4a` | відлік підготовки | записано |
| Один. | завжди | `audio/uk/common/countdown_1.m4a` | відлік підготовки | записано |
| Десять. | завжди | `audio/uk/common/countdown_10.m4a` | відлік підготовки | записано |
...
| Шість. | завжди | `audio/uk/common/countdown_6.m4a` | відлік підготовки | записано |
| Сім. | завжди | `audio/uk/common/countdown_7.m4a` | відлік підготовки | записано |
| Вісім. | завжди | `audio/uk/common/countdown_8.m4a` | відлік підготовки | записано |
| Дев'ять. | завжди | `audio/uk/common/countdown_9.m4a` | відлік підготовки | записано |
| Починаємо вправу через п'ять. | завжди | `audio/uk/common/countdown_opening.m4a` | відлік підготовки | записано |
...
| Перерва між вправами — десять секунд. | завжди | `audio/uk/common/rest_intro.m4a` | перерва між вправами | записано |

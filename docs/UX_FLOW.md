...
- «Прочитати інструкцію» — початкове положення, пронумеровані кроки і
  «Зверніть увагу» розгортаються під моделлю, нічого не звучить. Та сама
  кнопка згортає їх назад.

Жодне з двох не відбувається саме по собі: повний текст під моделлю ламав
композицію екрана (DECISIONS 69). Блок безпеки — не інструкція і видимий
завжди. Коли голос вимкнено в налаштуваннях, кнопки «Прослухати» немає
взагалі, і «Прочитати» займає весь рядок.

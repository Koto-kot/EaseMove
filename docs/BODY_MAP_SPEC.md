...
> **Артворк і hotspot-и доставлені.** Канонічні файли —
> `assets/ui/home/body/body_front.png`, `assets/ui/home/body/body_back_mini.png`
> і `data/ui/body_map/body_hotspots.yaml` (`docs/ui/home/`), а не прототипні
> координати, які описує цей документ. Чинним тут лишається принцип:
> нормалізовані координати, hotspot-и не вбудовані в зображення, тап по зоні
> веде в колекцію.
